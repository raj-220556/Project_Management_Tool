...
// Fetch projects for dropdown where manager is manager_id or project is in org
// Manager can see all projects in org just like Admin, but usually we restrict if needed.
// According to projects.php, they can see org projects.
